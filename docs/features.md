...
- **Preview**: ![FAQ Manager Preview](./doc-sonata-extra-images/faq-manager-preview.png)
...
- **Preview**: ![Article Manager Preview](./doc-sonata-extra-images/article-manager-preview.png)


### Sonata Admin FormTypes
- Additional FormTypes for Sonata Admin
- **Preview**: ![FormTypes Preview](./doc-sonata-extra-images/formtypes-preview.png)
